...
public class DialogVariableConfiguration extends TitleAreaDialog implements IDialog {
		...
		text.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent arg0) {
				try {
					...
					setErrorMessage("Parameter '" + parameterLabels.get(parameter.getName()) + "' has to be of type "
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.dialogs.TitleAreaDialog#setErrorMessage(java.lang.String)
	 */
	@Override
